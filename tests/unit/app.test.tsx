...
const mockApi: WindowApi = {
  ...
  setDefaultDarkTheme: vi.fn().mockResolvedValue(undefined),
  setDefaultLightTheme: vi.fn().mockResolvedValue(undefined),
  reloadThemes: vi.fn().mockResolvedValue({
    themes: [],
    activeThemeId: 'one-dark',
    defaultDarkThemeId: 'one-dark',
    defaultLightThemeId: 'one-light',
  ...
  getKeybindingOverrides: vi.fn().mockResolvedValue([]),
  setKeybindingOverrides: vi.fn().mockResolvedValue(undefined),
  onKeybindingsChanged: vi.fn().mockReturnValue(() => {}),
  ...
  chatSendMessage: vi.fn().mockResolvedValue({ messageId: 'm1' }),
  ...
  chatListPendingToolApprovals: vi.fn().mockResolvedValue([]),
  mcpListServers: vi.fn().mockResolvedValue([]),
  mcpRestartServer: vi.fn().mockResolvedValue({ success: true }),
  mcpListTools: vi.fn().mockResolvedValue([]),
  onMcpServerStatus: vi.fn().mockReturnValue(() => {}),
  cliAgentStart: vi.fn().mockResolvedValue({ sessionId: 'cli-1' }),
  cliAgentStop: vi.fn(),
  cliAgentSend: vi.fn().mockResolvedValue({ success: true }),
  cliAgentGetSession: vi.fn().mockResolvedValue(null),
  cliAgentLoadMessages: vi.fn().mockResolvedValue([]),
  ...
  conversationRename: vi.fn().mockResolvedValue(undefined),
